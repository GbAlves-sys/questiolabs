...
class Exam(db.Model):
    ...
    questions = db.relationship('Question', secondary='exam_questions', backref=db.backref('exams', lazy=True))

# Tabela de associação para relação muitos-para-muitos entre Prova e Questão
